...
type PropiedadesDeEmergente = {
  ...
  descripcion?: string;
  children?: ReactNode;
  /** Los botones del pie. Van con `BotonDeEmergente`. */
  acciones?: ReactNode;
 ...
 */
export function BotonDeEmergente({
  variante = "secundario",
  children,
  ...props
}: React.ComponentProps<typeof Boton>) {
  return (
    <Boton variante={variante} anchoCompleto {...props}>
      {children}
    </Boton>
  );
}
